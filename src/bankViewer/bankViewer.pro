SOURCES	+= ContigPicker.cc Insert.cc InsertWidget.cc InsertCanvas.cc InsertCanvasItem.cc InsertField.cc InsertWindow.cc InsertPosition.cc UIElements.cc TilingField.cc ConsensusField.cc TilingFrame.cc RenderSeq.cc ReadInfo.cc ChromoField.cc MainWindow.cc main.cc 
HEADERS	+= ContigPicker.hh Insert.hh InsertWidget.hh InsertCanvas.cc InsertCanvasItem.hh InsertField.hh InsertWindow.hh InsertPosition.hh UIElements.hh TilingField.hh ConsensusField.hh TilingFrame.hh RenderSeq.hh ReadInfo.hh ChromoField.hh MainWindow.hh
######################################################################
