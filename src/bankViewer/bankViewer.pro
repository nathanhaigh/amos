SOURCES	+= TilingField.cc lcdrange.cc RenderSeq.cc ReadInfo.cc ChromoField.cc MainWindow.cc main.cc 
HEADERS	+= TilingField.hh lcdrange.hh RenderSeq.hh ReadInfo.hh ChromoField.hh MainWindow.hh
######################################################################
