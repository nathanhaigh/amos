SOURCES	+= TilingField.cc RenderSeq.cc ReadInfo.cc ChromoField.cc MainWindow.cc main.cc 
HEADERS	+= TilingField.hh RenderSeq.hh ReadInfo.hh ChromoField.hh MainWindow.hh
######################################################################
