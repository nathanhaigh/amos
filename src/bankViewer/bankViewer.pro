SOURCES	+= ScaffoldPicker.cc NetworkCom.cc FeatureCanvasItem.cc ChromoPicker.cc CoverageCanvasItem.cc FeatureBrowser.cc LibraryPicker.cc ReadPicker.cc DataStore.cc CGraphWindow.cc CGraphContig.cc CGraphView.cc CGraphEdge.cc ContigPicker.cc Insert.cc InsertWidget.cc InsertCanvasItem.cc InsertField.cc InsertWindow.cc InsertPosition.cc UIElements.cc TilingField.cc ConsensusField.cc TilingFrame.cc RenderSeq.cc ReadInfo.cc ChromoField.cc MainWindow.cc main.cc 
HEADERS	+= ScaffoldPicker.hh NetworkCom.hh FeatureCanvasItem.hh ChromoPicker.hh CoverageCanvasItem.hh FeatureBrowser.hh LibraryPicker.hh ReadPicker.hh DataStore.hh CGraphWindow.hh CGraphContig.hh CGraphView.hh CGraphEdge.hh ContigPicker.hh Insert.hh InsertWidget.hh InsertCanvasItem.hh InsertField.hh InsertWindow.hh InsertPosition.hh UIElements.hh TilingField.hh ConsensusField.hh TilingFrame.hh RenderSeq.hh ReadInfo.hh ChromoField.hh MainWindow.hh
######################################################################
