...
//----------------------------------------------------- append -----------------
ID_t Bank_t::append (Bankable_t & obj)
{
  //-- Check preconditions
  if ( !isOpen( ) )
...
//----------------------------------------------------- fetch ------------------
void Bank_t::fetch (Bankable_t & obj)
{
  ID_t iid = obj . getIID( );
  if ( iid == NULL_ID )
    return;
...
//----------------------------------------------------- remove -----------------
void Bank_t::remove (Bankable_t & obj)
{
  ID_t iid = obj . getIID( );
  if ( iid == NULL_ID )
    return;
...
//----------------------------------------------------- replace ----------------
void Bank_t::replace (Bankable_t & obj)
{
  ID_t iid = obj . getIID( );
  if ( iid == NULL_ID )
    return;
...
//--------------------------------------------------- restore ----------------
void Bank_t::restore (Bankable_t & obj)
{
  ID_t iid = obj . getIID( );
  if ( iid == NULL_ID )
    return;
