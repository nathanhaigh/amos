...
echo "bootstrap error" >> /home/bryanta/ubuntuFirst_Failed.log
/usr/bin/expect <<EOD
...
then
cp /home/bryanta/ubuntuFirst.log /home/bryanta/ubuntuFirst_Failed.log
echo "configure error" >> /home/bryanta/ubuntuFirst_Failed.log
/usr/bin/expect <<EOD
spawn scp /home/bryanta/ubuntuFirst_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /home/bryanta/ubuntuFirst.log /home/bryanta/ubuntuFirst_Failed.log
echo "make error" >> /home/bryanta/ubuntuFirst_Failed.log
/usr/bin/expect <<EOD
spawn scp /home/bryanta/ubuntuFirst_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /home/bryanta/ubuntuFirst.log /home/bryanta/ubuntuFirst_Failed.log
echo "make check error" >> /home/bryanta/ubuntuFirst_Failed.log
/usr/bin/expect <<EOD
spawn scp /home/bryanta/ubuntuFirst_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /home/bryanta/ubuntuFirst.log /home/bryanta/ubuntuFirst_Failed.log
echo "make install error" >> /home/bryanta/ubuntuFirst_Failed.log
/usr/bin/expect <<EOD
spawn scp /home/bryanta/ubuntuFirst_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
