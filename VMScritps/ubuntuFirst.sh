...
echo "*** Bootstrap Failed" >> /home/bryanta/ubuntuFirst_Failed.log
/usr/bin/expect <<EOD
...
then
cp /home/bryanta/ubuntuFirst.log /home/bryanta/ubuntuFirst_Failed.log
echo "*** Configure Failed" >> /home/bryanta/ubuntuFirst_Failed.log
/usr/bin/expect <<EOD
spawn scp /home/bryanta/ubuntuFirst_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /home/bryanta/ubuntuFirst.log /home/bryanta/ubuntuFirst_Failed.log
echo "*** Make Failed" >> /home/bryanta/ubuntuFirst_Failed.log
/usr/bin/expect <<EOD
spawn scp /home/bryanta/ubuntuFirst_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /home/bryanta/ubuntuFirst.log /home/bryanta/ubuntuFirst_Failed.log
echo "*** Make Check Failed" >> /home/bryanta/ubuntuFirst_Failed.log
/usr/bin/expect <<EOD
spawn scp /home/bryanta/ubuntuFirst_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /home/bryanta/ubuntuFirst.log /home/bryanta/ubuntuFirst_Failed.log
echo "*** Make Install Failed" >> /home/bryanta/ubuntuFirst_Failed.log
/usr/bin/expect <<EOD
spawn scp /home/bryanta/ubuntuFirst_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
