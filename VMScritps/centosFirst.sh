...
echo "*** Bootstrap Failed" >> /home/bryanta/centOSFirst_Failed.log
/usr/bin/expect <<EOD
...
then
cp /home/bryanta/centOSFirst.log /home/bryanta/centOSFirst_Failed.log
echo "*** Configure Failed" >> /home/bryanta/centOSFirst_Failed.log
/usr/bin/expect <<EOD
spawn scp /home/bryanta/centOSFirst_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /home/bryanta/centOSFirst.log /home/bryanta/centOSFirst_Failed.log
echo "*** Make Failed" >> /home/bryanta/centOSFirst_Failed.log
/usr/bin/expect <<EOD
spawn scp /home/bryanta/centOSFirst_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /home/bryanta/centOSFirst.log /home/bryanta/centOSFirst_Failed.log
echo "*** Make Check Failed" >> /home/bryanta/centOSFirst_Failed.log
/usr/bin/expect <<EOD
spawn scp /home/bryanta/centOSFirst_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /home/bryanta/centOSFirst.log /home/bryanta/centOSFirst_Failed.log
echo "*** Make Install Failed" >> /home/bryanta/centOSFirst_Failed.log
/usr/bin/expect <<EOD
spawn scp /home/bryanta/centOSFirst_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
