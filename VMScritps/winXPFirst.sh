...
echo "bootstrap error" >> /cygdrive/c/cygwin/winXPFirst_Failed.log
/usr/bin/expect <<EOD
...
then
cp /cygdrive/c/cygwin/winXPFirst.log /cygdrive/c/cygwin/winXPFirst_Failed.log
echo "configure error" >> /cygdrive/c/cygwin/winXPFirst_Failed.log
/usr/bin/expect <<EOD
spawn scp /cygdrive/c/cygwin/winXPFirst_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /cygdrive/c/cygwin/winXPFirst.log /cygdrive/c/cygwin/winXPFirst_Failed.log
echo "make error" >> /cygdrive/c/cygwin/winXPFirst_Failed.log
/usr/bin/expect <<EOD
spawn scp /cygdrive/c/cygwin/winXPFirst_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
