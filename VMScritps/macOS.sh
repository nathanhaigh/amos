...
echo "*** Bootstrap Failed" >> /Users/amos/macOS_Failed.log
/usr/bin/expect <<EOD
...
then
cp /Users/amos/macOS.log /Users/amos/macOS_Failed.log
echo "*** Configure Failed" >> /Users/amos/macOS_Failed.log
/usr/bin/expect <<EOD
spawn scp /Users/amos/macOS_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /Users/amos/macOS.log /Users/amos/macOS_Failed.log
echo "*** Make Failed" >> /Users/amos/macOS_Failed.log
/usr/bin/expect <<EOD
spawn scp /Users/amos/macOS_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /Users/amos/macOS.log /Users/amos/macOS_Failed.log
echo "*** Make Check Failed" >> /Users/amos/macOS_Failed.log
/usr/bin/expect <<EOD
spawn scp /Users/amos/macOS_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /Users/amos/macOS.log /Users/amos/macOS_Failed.log
echo "*** Make Install Failed" >> /Users/amos/macOS_Failed.log
/usr/bin/expect <<EOD
spawn scp /Users/amos/macOS_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
