...
echo "*** Bootstrap Failed" >> /cygdrive/c/cygwin/winXPLast_Failed.log
/usr/bin/expect <<EOD
...
then
cp /cygdrive/c/cygwin/winXPLast.log /cygdrive/c/cygwin/winXPLast_Failed.log
echo "*** Configure Failed" >> /cygdrive/c/cygwin/winXPLast_Failed.log
/usr/bin/expect <<EOD
spawn scp /cygdrive/c/cygwin/winXPLast_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /cygdrive/c/cygwin/winXPLast.log /cygdrive/c/cygwin/winXPLast_Failed.log
echo "*** Make Failed" >> /cygdrive/c/cygwin/winXPLast_Failed.log
/usr/bin/expect <<EOD
spawn scp /cygdrive/c/cygwin/winXPLast_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
...
then
cp /cygdrive/c/cygwin/winXPLast.log /cygdrive/c/cygwin/winXPLast_Failed.log
echo "*** Make Install Failed" >> /cygdrive/c/cygwin/winXPLast_Failed.log
/usr/bin/expect <<EOD
spawn scp /cygdrive/c/cygwin/winXPLast_Failed.log ssh@sauron.cs.umd.edu:VMlogs
expect "ssh@sauron.cs.umd.edu's password:"
send "123\r"
